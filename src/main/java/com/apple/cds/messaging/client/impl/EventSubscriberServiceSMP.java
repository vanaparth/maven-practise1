...
public abstract class EventSubscriberServiceSMP<LogEvent> extends EventSubscriberService<LogEvent>
{
    private static final Logger LOGGER = Logger.getLogger(EventSubscriberServiceSMP.class);

    private LoggingSubscriberMQServiceImpl<LogEvent> subscriber;

    protected EventSubscriberServiceSMP(String queueName)
    {
    ...
    private void createAndSetEventListener()
    {
