...
class SMPEventValidationMap
{
    ...
    private Map<SMPDeviceEvent, Set<String>> getValidationMap()
    {
        ...
        map.put(SMPDeviceEvent.RESUME_CARD, new HashSet<>(Arrays.asList("con", "cst", "dpn", "evt", "pno", "tim")));
        ...
        map.put(SMPDeviceEvent.GET_OTP_RESOLUTION_METHODS, new HashSet<>(Arrays.asList("con", "evt", "pno", "tim")));
